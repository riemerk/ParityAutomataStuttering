Recall the definitions about guardedness for $\mu$-ML formulas and parity formulas.
...
\end{proof}
\begin{theorem}
 Let $\phi$ be a $\mu$-TL formula. Without loss of generality assume $\phi$ is guarded, simple and $U/R$ free. Let $\mathbb{H}_\phi$ the parity formula from theorem . This $\mathbb{H}_\phi$ is strongly guarded and simple
\end{theorem}
\begin{proof}
